...
import { X, Volume2, RotateCcw, ChevronRight, Trophy, Zap } from 'lucide-react';
            ...
            <Button
              ...
              className={cn(
                ...
                isPlaying
                  ...
                  : "bg-gradient-to-br from-primary to-primary/70 hover:scale-105 cursor-pointer"
              )}
            >
              {isPlaying ? (
            ...
            {options.map((option) => {
              ...
              return (
                <Button
                  ...
                  className={cn(
                    "p-6 rounded-2xl border-2 transition-all duration-300 text-left h-auto",
                    ...
                    showResult && isSelected && !isCorrectOption && "border-rose-500 bg-rose-50",
