...
// Remove your OWN pronunciation of a word (soft-delete; the audio file is kept).
export async function DELETE(
  _request: NextRequest,
  context: { params: Promise<{ id: string; recordingId: string }> },
) {
  const { id: wordId, recordingId } = await context.params;
