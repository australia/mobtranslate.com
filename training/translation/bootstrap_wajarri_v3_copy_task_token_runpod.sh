...
VENV=${WBV_VENV:-/workspace/wbv-v3-copy-task-token-screen-venv}
...
if contract["claims"]["sealed_test_included"] is not False:
    raise SystemExit("Screening kit must not include the sealed Wajarri test")
if contract["experiment_kind"] != "dedicated_copy_task_token":
